package algorithm.Like_lion.week4.algorithm_1025.hash;
...
public class HashTable {
    ...
    public static void main(String[] args) {
        ...
        HashTable h = new HashTable(200);
        for(int i=0;i<names.length; i++){
            h.insert(names[i], h.hash(names[i]));
        }
        System.out.println(h.search("DongyeonKang"));
    }
}
